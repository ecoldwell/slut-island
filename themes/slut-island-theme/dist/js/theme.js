...
var menuDropdowns = function () {
  $("body").on("click", ".menu-item-has-children > a", function(event) {
    ...
    $(".menu-item-has-children.sub-menu-visible").removeClass("sub-menu-visible");

    var $clickedElement = $(event.target),
        $wrappingElement = $clickedElement.closest(".menu-item-has-children");

    $wrappingElement.addClass("sub-menu-visible")

    $(document).one("click", function(){
      $wrappingElement.removeClass("sub-menu-visible")
    })
